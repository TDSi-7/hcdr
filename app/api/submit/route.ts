...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!hasCompleteQuizAnswers(body.answers)) {
    ...
    // Only optional metadata may be removed. Quiz answers, the computed result,
    // contact/provider data and consent records must never be silently dropped.
