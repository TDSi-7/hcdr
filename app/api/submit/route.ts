...
import { normalizeQuizAnswers, type QuizAnswers } from "@/lib/quiz-validation";
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Optional metadata can fall back for schema drift, but quiz answers,
    // profile, required contact fields, and consent must be persisted together.
